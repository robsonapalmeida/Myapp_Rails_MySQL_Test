...
class AgendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post agendas_url, params: { agenda: { agenda: @agenda.agenda, emailempleado: @agenda.emailempleado, nomeempleado: @agenda.nomeempleado, observacion: @agenda.observacion, tiposervico: @agenda.tiposervico } }
    end
  ...
  test "should update agenda" do
    patch agenda_url(@agenda), params: { agenda: { agenda: @agenda.agenda, emailempleado: @agenda.emailempleado, nomeempleado: @agenda.nomeempleado, observacion: @agenda.observacion, tiposervico: @agenda.tiposervico } }
