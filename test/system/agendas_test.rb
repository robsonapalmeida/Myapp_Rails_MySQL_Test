...
class AgendasTest < ApplicationSystemTestCase
  ...
  test "creating a Agenda" do
    ...
    fill_in "Emailempleado", with: @agenda.emailempleado
    fill_in "Nomeempleado", with: @agenda.nomeempleado
    fill_in "Observacion", with: @agenda.observacion
    fill_in "Tiposervico", with: @agenda.tiposervico
